...
```bash
# Test auth endpoint
curl -X GET "https://robotix-connect.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://robotix-connect.preview.emergentagent.com/api/jobs" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context.add_cookies([{
    ...
    "domain": "robotix-connect.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://robotix-connect.preview.emergentagent.com");
```
...
- Ensure proper field mapping in models
